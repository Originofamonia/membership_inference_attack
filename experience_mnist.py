...
def experience_mnist(config, path, param):
    ...
    data_train_target = custum_MNIST(True, 0, config, '../data', train=True,
                                     download=True,
    ...
    data_test_target = custum_MNIST(True, 0, config, '../data', train=False,
                                    transform=transforms.Compose([
                                        transforms.ToTensor(),
                                        transforms.Normalize((0.1307,),
                                                             (0.3081,))
    ...
    for num_model_sahdow in range(config.general.number_shadow_model):
        ...
        data_train_shadow = custum_MNIST(False, num_model_sahdow, config,
        ...
        data_test_shadow = custum_MNIST(False, num_model_sahdow, config,
                                        '../data', train=False,
                                        transform=transforms.Compose([
                                            transforms.ToTensor(),
                                            transforms.Normalize((0.1307,),
