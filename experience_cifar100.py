...
def experience_cifar100(config, path, param):
    ...
    data_train_target = custum_CIFAR100(True, 0, config, '../data', train=True,
                                        download=True,
    ...
    data_test_target = custum_CIFAR100(True, 0, config, '../data', train=False,
                                       transform=transforms.Compose([
                                           transforms.ToTensor(),
    ...
    for num_model_sahdow in range(config.general.number_shadow_model):
        criterion = nn.CrossEntropyLoss()
        data_train_shadow = custum_CIFAR100(False, num_model_sahdow, config,
                                            '../data', train=True,
                                            download=True,
                                            transform=transforms.Compose([
                                                transforms.ToTensor(),
        ...
        data_test_shadow = custum_CIFAR100(False, num_model_sahdow, config,
                                           '../data', train=False,
                                           transform=transforms.Compose([
                                               transforms.ToTensor(),
                                               transforms.Normalize(
